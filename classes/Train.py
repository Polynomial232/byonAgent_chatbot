...
class Train():
    ...
    def __init__(self, model_folder, epochs=400):
        self.epochs = epochs
    ...
    def start(self):
        ...
        pre_proses = PreProses(self.model_folder)
        ...
        file = f'model/{self.model_folder}/data.pth'
    ...
    def currect_train(self):
        ...
        data = {
            "last_loss": self.data.get('history')[-1],
            "min_loss": min(self.data.get('history')),
            "image_history": f'/model/{self.model_folder}/histroy_train.jpg',
            "updated_at": self.data.get('updated_at')
        }

        with open(f'model/{self.model_folder}/current.json',
    ...
    def plot_history(self):
        ...
        plt.savefig(f'model/{self.model_folder}/histroy_train.jpg')
